...
image_files = [
    input_path + "image_2024-05-30-20-49-40.png",
    input_path + "image_2024-05-30-20-57-00.png",
    input_path + "image_2024-05-30-21-00-34.png",
]
...
video.write_videofile(
    f"./outputs/videos/video-{get_current_datetime_str()}.mp4",
    codec="libx264",
    audio_codec="aac",
    fps=24,
)
